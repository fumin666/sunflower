...
export default {
    ...
    return (
      <table
        ...
        <colgroup>
          ...
          {
            this.hasGutter
              ? <col name="gutter" width={ this.layout.scrollX ? this.layout.gutterWidth : '' }></col>
              : ''
          }
        </colgroup>
        <thead class={ [{ 'is-group': isGroup, 'has-gutter': this.hasGutter }] }>
          {
            this._l(columnRows, (columns, rowIndex) =>
              <tr
                ...
                class={ this.getHeaderRowClass(rowIndex), this.hasGutter ? 'gutterTr' : '' }
              >
              {
              ...
              {
                this.hasGutter
                  ? <th class="gutter" style={{ width: this.layout.scrollX ? this.layout.gutterWidth + 'px' : '0' }}></th>
                  : ''
              }
              </tr>
            )
  ...
  computed: {
    ...
    hasGutter() {
      return !this.fixed && this.layout.gutterWidth && this.layout.scrollX;
    }
  },
