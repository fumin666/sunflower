<template>
  <ul @click="onPagerClick" class="s-pager" :class="{'noborder':noBorder}" v-if="!infinite">
    <li
    ...
    <li
      ...
      v-if="showPrevMore"
      v-text="quickprevIconClass === 's-icon-more'?'· · ·': null"
      @mouseenter="quickprevIconClass = 'icon-double-left'"
    ...
    <li
      ...
      v-if="showNextMore"
      v-text="quicknextIconClass === 's-icon-more'?'· · ·': null"
      @mouseenter="quicknextIconClass = 'icon-double-right'"
  ...
  <ul @click="onPagerClick" class="s-pager" :class="{'noborder':noBorder}" v-else>
    <li
    ...
    <li
      ...
      :class="[quicknextIconClass]"
      v-if="!(!hasNext && (pageCount === currentPage || pageCount === 0))">
      . . .
    </li>
  </ul>
</template>
