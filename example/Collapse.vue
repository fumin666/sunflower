<template>
  <article class="article">
    ...
    <h3>基础用法</h3>
    <s-button @click="handleChange">点击</s-button>
    <div class="example">
      <div class="example-demo">
        <s-collapse v-model="activeNames">
          <s-collapse-item title="史蒂夫·乔布斯" name="1">
            <div>史蒂夫·乔布斯（Steve Jobs），1955年2月24日生于美国加利福尼亚州旧金山，美国发明家、企业家、美国苹果公司联合创办人。</div>
          </s-collapse-item>
          <s-collapse-item title="斯蒂夫·盖瑞·沃兹尼亚克" name="2">
          ...
          <s-collapse-item title="乔纳森·伊夫" name="3" >
...
&lt;/script&gt;
    ...
    <div class="example">
      ...
      <div class="example-code" >
        <div class="description"><p>通过 <code>accordion</code> 属性来设置是否以手风琴模式显示。</p></div>
            <pre>
              <code>
&lt;s-collapse v-model="activeNames" accordion&gt;
  &lt;s-collapse-item title="一致性 Consistency" name="1"&gt;
    ...
    <div class="example">
      <div class="example-demo">
        <s-collapse accordion>
          <s-collapse-item>
            <template slot="title">
              一致性 Consistency<i style="margin-left:10px;vertical-align: middle;" class="iconfont icon-clock"></i>
            </template>
            <div>与现实生活一致：与现实生活的流程、逻辑保持一致，遵循用户习惯的语言和概念；</div>
            <div>在界面中一致：所有的元素和结构需保持一致，比如：设计样式、图标和文本、元素的位置等。</div>
          </s-collapse-item>
...
&lt;/s-collapse&gt;
    ...
    <h3 id="collapse-events"> Collapse Events</h3>
    <table class="table">
      <thead>
      <tr>
        <th>事件名称</th>
    ...
    <h3 id="collapse-item-attributes"> Collapse Item Attributes</h3>
    <table class="table">
      <thead>
      <tr>
        <th>参数</th>
